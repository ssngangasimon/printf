 ...
 * @ind: index number on the buffer
 * @buffer: Buffer
 * @flags: flags
 * @width: width
 ...
 * @is_negative: num indicating if number is negative
 * @ind: index number on the buffer
...
int write_unsgnd(int is_negative, int ind,
	...
	int flags, int width, int precision, int size)
{
	/* number is kept at the right of the buffer and begins at position i */
 ...
 * @padd: padding represented by Char
 * @extra_c: extra char
 * @padd_start: index where padding start
 *
